...
#ifndef CARTOGRAPHER_MAPPING_NO_IMU_POSE_EXTRAPOLATOR_H_
#define CARTOGRAPHER_MAPPING_NO_IMU_POSE_EXTRAPOLATOR_H_
...
class NoImuPoseExtrapolator : public PoseExtrapolatorInterface {
 public:
  explicit NoImuPoseExtrapolator(common::Duration pose_queue_duration);

  NoImuPoseExtrapolator(const NoImuPoseExtrapolator&) = delete;
  NoImuPoseExtrapolator& operator=(const NoImuPoseExtrapolator&) = delete;
...
#endif  // CARTOGRAPHER_MAPPING_NO_IMU_POSE_EXTRAPOLATOR_H_
